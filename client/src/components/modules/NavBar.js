    ...
    render() {
      return (
          <nav className="navbar-container">
              <Link to="/" className="navbar-title header-font">Vector Drawing</Link>
              <div className="navbar-link-container">
                <Link to="/inspiration" className="navbar-link header-font" >
                  Inspiration
                </Link>
                <a className="navbar-link" href="https://github.com/jronmi" target ="_blank">
                  <svg  _ngcontent-xvk-c0="" viewBox="0 0 28 28" width="40" height="40" xmlns="http://www.w3.org/2000/svg">
